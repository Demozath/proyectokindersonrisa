...
from llamadas.views import LlamadaListView, registrar_llamada, revisar_llamadas, cargar_pacientes, gestionar_tipos_llamada, pacientes_no_llamar, gestion_usuarios
